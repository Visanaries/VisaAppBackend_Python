...
------------ | ------------- | ------------- | -------------
*VqiApi* | [**postvqi_service**](docs/VqiApi.md#postvqi_service) | **POST** /visaqueueinsights/v1/queueinsights | 


## Documentation For Models

 - [FeedbackList](docs/FeedbackList.md)
 - [FeedbackListInner](docs/FeedbackListInner.md)
 - [FeedbackUpdateList](docs/FeedbackUpdateList.md)
 - [FeedbackUpdateListInner](docs/FeedbackUpdateListInner.md)
 - [MerchantList](docs/MerchantList.md)
 - [MerchantListInner](docs/MerchantListInner.md)
 - [RequestData](docs/RequestData.md)
 - [RequestHeader](docs/RequestHeader.md)
 - [ResponseData](docs/ResponseData.md)
 - [ResponseHeader](docs/ResponseHeader.md)
 - [Status](docs/Status.md)
 - [VqiServicepostPayload](docs/VqiServicepostPayload.md)
 - [VqiServicepostResponse](docs/VqiServicepostResponse.md)

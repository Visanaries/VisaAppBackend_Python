...
class MerchandiseReturnReversalGetgetResponse(object):
    """
    ...
    def __init__(self, approval_code=None, fee_program_indicator=None, merchant_verification_value=None, status_identifier=None, transaction_identifier=None, response_code=None, action_code=None, transmission_date_time=None):
        """
        MerchandiseReturnReversalGetgetResponse - a model defined in Swagger
    ...
    def approval_code(self):
        """
        Gets the approval_code of this MerchandiseReturnReversalGetgetResponse.
        The authorization code from the issuer.

        :return: The approval_code of this MerchandiseReturnReversalGetgetResponse.
        :rtype: str
        """
    ...
    def approval_code(self, approval_code):
        """
        Sets the approval_code of this MerchandiseReturnReversalGetgetResponse.
        The authorization code from the issuer.

        :param approval_code: The approval_code of this MerchandiseReturnReversalGetgetResponse.
        :type: str
        """
    ...
    def fee_program_indicator(self):
        """
        Gets the fee_program_indicator of this MerchandiseReturnReversalGetgetResponse.
        Optional field which may be populated by recipient where applicable.

        :return: The fee_program_indicator of this MerchandiseReturnReversalGetgetResponse.
        :rtype: str
        """
    ...
    def fee_program_indicator(self, fee_program_indicator):
        """
        Sets the fee_program_indicator of this MerchandiseReturnReversalGetgetResponse.
        Optional field which may be populated by recipient where applicable.

        :param fee_program_indicator: The fee_program_indicator of this MerchandiseReturnReversalGetgetResponse.
        :type: str
        """
    ...
    def merchant_verification_value(self):
        """
        Gets the merchant_verification_value of this MerchandiseReturnReversalGetgetResponse.
        The concatenated Merchant Verification Value of Visa assigned and Acquirer assigned value is returned.

        :return: The merchant_verification_value of this MerchandiseReturnReversalGetgetResponse.
        :rtype: str
        """
    ...
    def merchant_verification_value(self, merchant_verification_value):
        """
        Sets the merchant_verification_value of this MerchandiseReturnReversalGetgetResponse.
        The concatenated Merchant Verification Value of Visa assigned and Acquirer assigned value is returned.

        :param merchant_verification_value: The merchant_verification_value of this MerchandiseReturnReversalGetgetResponse.
        :type: str
        """
    ...
    def status_identifier(self):
        """
        Gets the status_identifier of this MerchandiseReturnReversalGetgetResponse.
        required when call times out

        :return: The status_identifier of this MerchandiseReturnReversalGetgetResponse.
        :rtype: str
        """
    ...
    def status_identifier(self, status_identifier):
        """
        Sets the status_identifier of this MerchandiseReturnReversalGetgetResponse.
        required when call times out

        :param status_identifier: The status_identifier of this MerchandiseReturnReversalGetgetResponse.
        :type: str
        """
    ...
    def transaction_identifier(self):
        """
        Gets the transaction_identifier of this MerchandiseReturnReversalGetgetResponse.
        It contains a right-justified, VisaNet generated Transaction Identifier (TID).

        :return: The transaction_identifier of this MerchandiseReturnReversalGetgetResponse.
        :rtype: str
        """
    ...
    def transaction_identifier(self, transaction_identifier):
        """
        Sets the transaction_identifier of this MerchandiseReturnReversalGetgetResponse.
        It contains a right-justified, VisaNet generated Transaction Identifier (TID).

        :param transaction_identifier: The transaction_identifier of this MerchandiseReturnReversalGetgetResponse.
        :type: str
        """
    ...
    def response_code(self):
        """
        Gets the response_code of this MerchandiseReturnReversalGetgetResponse.
        ...
        :return: The response_code of this MerchandiseReturnReversalGetgetResponse.
        :rtype: str
        """
    ...
    def response_code(self, response_code):
        """
        Sets the response_code of this MerchandiseReturnReversalGetgetResponse.
        The source for the response; typically, either the recipient issuer or a Visa system.Refer to  The VisaNet Response Source for the transaction

        :param response_code: The response_code of this MerchandiseReturnReversalGetgetResponse.
        :type: str
        """
    ...
    def action_code(self):
        """
        Gets the action_code of this MerchandiseReturnReversalGetgetResponse.
        It contains a code that defines the response to a request

        :return: The action_code of this MerchandiseReturnReversalGetgetResponse.
        :rtype: str
        """
    ...
    def action_code(self, action_code):
        """
        Sets the action_code of this MerchandiseReturnReversalGetgetResponse.
        It contains a code that defines the response to a request

        :param action_code: The action_code of this MerchandiseReturnReversalGetgetResponse.
        :type: str
        """
    ...
    def transmission_date_time(self):
        """
        Gets the transmission_date_time of this MerchandiseReturnReversalGetgetResponse.
        Transmission date and time

        :return: The transmission_date_time of this MerchandiseReturnReversalGetgetResponse.
        :rtype: str
        """
    ...
    def transmission_date_time(self, transmission_date_time):
        """
        Sets the transmission_date_time of this MerchandiseReturnReversalGetgetResponse.
        Transmission date and time

        :param transmission_date_time: The transmission_date_time of this MerchandiseReturnReversalGetgetResponse.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, MerchandiseReturnReversalGetgetResponse):
            return False

...
class MultipullfundstransactionsgetResponse(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, approval_code=None, fee_program_indicator=None, last4of_pan=None, cavv_result_code=None, status_identifier=None, transaction_identifier=None, member_comments=None, response_code=None, action_code=None, cps_authorization_characteristics_indicator=None, reimbursement_attribute=None, transmission_date_time=None):
        """
        MultipullfundstransactionsgetResponse - a model defined in Swagger
    ...
    def approval_code(self):
        """
        Gets the approval_code of this MultipullfundstransactionsgetResponse.
        The authorization code from the issuer.

        :return: The approval_code of this MultipullfundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def approval_code(self, approval_code):
        """
        Sets the approval_code of this MultipullfundstransactionsgetResponse.
        The authorization code from the issuer.

        :param approval_code: The approval_code of this MultipullfundstransactionsgetResponse.
        :type: str
        """
    ...
    def fee_program_indicator(self):
        """
        Gets the fee_program_indicator of this MultipullfundstransactionsgetResponse.
        

        :return: The fee_program_indicator of this MultipullfundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def fee_program_indicator(self, fee_program_indicator):
        """
        Sets the fee_program_indicator of this MultipullfundstransactionsgetResponse.
        

        :param fee_program_indicator: The fee_program_indicator of this MultipullfundstransactionsgetResponse.
        :type: str
        """
    ...
    def last4of_pan(self):
        """
        Gets the last4of_pan of this MultipullfundstransactionsgetResponse.
        This field contains the last four digits of the cardholder primary account number (PAN)

        :return: The last4of_pan of this MultipullfundstransactionsgetResponse.
        :rtype: int
        """
    ...
    def last4of_pan(self, last4of_pan):
        """
        Sets the last4of_pan of this MultipullfundstransactionsgetResponse.
        This field contains the last four digits of the cardholder primary account number (PAN)

        :param last4of_pan: The last4of_pan of this MultipullfundstransactionsgetResponse.
        :type: int
        """
    ...
    def cavv_result_code(self):
        """
        Gets the cavv_result_code of this MultipullfundstransactionsgetResponse.
        ...
        :return: The cavv_result_code of this MultipullfundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def cavv_result_code(self, cavv_result_code):
        """
        Sets the cavv_result_code of this MultipullfundstransactionsgetResponse.
        The cavvResultCode identifies the outcome of the CAVV validation. <br><br>Refer to <a href=\"/request_response_codes#cardholder_authentication_verification_value\">cavvResultCode</a>

        :param cavv_result_code: The cavv_result_code of this MultipullfundstransactionsgetResponse.
        :type: str
        """
    ...
    def status_identifier(self):
        """
        Gets the status_identifier of this MultipullfundstransactionsgetResponse.
        

        :return: The status_identifier of this MultipullfundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def status_identifier(self, status_identifier):
        """
        Sets the status_identifier of this MultipullfundstransactionsgetResponse.
        

        :param status_identifier: The status_identifier of this MultipullfundstransactionsgetResponse.
        :type: str
        """
    ...
    def transaction_identifier(self):
        """
        Gets the transaction_identifier of this MultipullfundstransactionsgetResponse.
        ...
        :return: The transaction_identifier of this MultipullfundstransactionsgetResponse.
        :rtype: int
        """
    ...
    def transaction_identifier(self, transaction_identifier):
        """
        Sets the transaction_identifier of this MultipullfundstransactionsgetResponse.
        The VisaNet reference number for the transaction<br><br><b>Note: </b><br>transactionIdentifier is a Visa generated field that client recieves in the response message.<br><b>Note: </b>As an exception Visa allows clients to use the transactionIdentifier received in the AFT response into the subsequent OCT message - this is to simplify matching the pull and push transaction pair and reconciliation.

        :param transaction_identifier: The transaction_identifier of this MultipullfundstransactionsgetResponse.
        :type: int
        """
    ...
    def member_comments(self):
        """
        Gets the member_comments of this MultipullfundstransactionsgetResponse.
        ...
        :return: The member_comments of this MultipullfundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def member_comments(self, member_comments):
        """
        Sets the member_comments of this MultipullfundstransactionsgetResponse.
        This field can be optionally used to send and receive comments by service providers. Issuers can optionally include new text in this field in the response. If the issuer does not include this field, Visa will inject the value from the request in the response and send it back to the service provider.

        :param member_comments: The member_comments of this MultipullfundstransactionsgetResponse.
        :type: str
        """
    ...
    def response_code(self):
        """
        Gets the response_code of this MultipullfundstransactionsgetResponse.
        ...
        :return: The response_code of this MultipullfundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def response_code(self, response_code):
        """
        Sets the response_code of this MultipullfundstransactionsgetResponse.
        The source for the response; typically, either the recipient issuer or a Visa system.<br><br>Refer to <a href=\"/request_response_codes#response_code\">response_code</a><br><b>Note: </b>: The VisaNet Response Source for the transaction

        :param response_code: The response_code of this MultipullfundstransactionsgetResponse.
        :type: str
        """
    ...
    def action_code(self):
        """
        Gets the action_code of this MultipullfundstransactionsgetResponse.
        ...
        :return: The action_code of this MultipullfundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def action_code(self, action_code):
        """
        Sets the action_code of this MultipullfundstransactionsgetResponse.
        The results of the transaction request <br><br>Refer to <a href=\"/request_response_codes#action_code\">actionCode</a><br><b>Note: </b>: The VisaNet Response Code for the transaction

        :param action_code: The action_code of this MultipullfundstransactionsgetResponse.
        :type: str
        """
    ...
    def cps_authorization_characteristics_indicator(self):
        """
        Gets the cps_authorization_characteristics_indicator of this MultipullfundstransactionsgetResponse.
        ...
        :return: The cps_authorization_characteristics_indicator of this MultipullfundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def cps_authorization_characteristics_indicator(self, cps_authorization_characteristics_indicator):
        """
        Sets the cps_authorization_characteristics_indicator of this MultipullfundstransactionsgetResponse.
        Indicates whether AFT transaction has qualified for CPS. Possible values are : F (Meets CPS/Account Funding requirements) , N (Not Qualified), T (Not Qualified)

        :param cps_authorization_characteristics_indicator: The cps_authorization_characteristics_indicator of this MultipullfundstransactionsgetResponse.
        :type: str
        """
    ...
    def reimbursement_attribute(self):
        """
        Gets the reimbursement_attribute of this MultipullfundstransactionsgetResponse.
        ...
        :return: The reimbursement_attribute of this MultipullfundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def reimbursement_attribute(self, reimbursement_attribute):
        """
        Sets the reimbursement_attribute of this MultipullfundstransactionsgetResponse.
        If AFT transaction has qualified for CPS then this field contains a code that identifies the applicable interchange reimbursement fee. Possible values are : A (Payment Service Interchange Reimbursement Fee (PSIRF)�U.S.)

        :param reimbursement_attribute: The reimbursement_attribute of this MultipullfundstransactionsgetResponse.
        :type: str
        """
    ...
    def transmission_date_time(self):
        """
        Gets the transmission_date_time of this MultipullfundstransactionsgetResponse.
        ...
        :return: The transmission_date_time of this MultipullfundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def transmission_date_time(self, transmission_date_time):
        """
        Sets the transmission_date_time of this MultipullfundstransactionsgetResponse.
        Example: 2016-01-15T07:03:52.000Z<br><b>Note: </b> Remove �.000Z� if this field value is used for ReverseFundsTransactions POST request or MultiReverseFundsTransactions POST request.

        :param transmission_date_time: The transmission_date_time of this MultipullfundstransactionsgetResponse.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, MultipullfundstransactionsgetResponse):
            return False

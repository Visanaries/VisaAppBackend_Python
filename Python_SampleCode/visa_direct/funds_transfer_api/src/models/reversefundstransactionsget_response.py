...
class ReversefundstransactionsgetResponse(object):
    """
    ...
    def __init__(self, approval_code=None, fee_program_indicator=None, last4of_pan=None, status_identifier=None, transaction_identifier=None, member_comments=None, response_code=None, action_code=None, transmission_date_time=None):
        """
        ReversefundstransactionsgetResponse - a model defined in Swagger
    ...
    def approval_code(self):
        """
        Gets the approval_code of this ReversefundstransactionsgetResponse.
        The authorization code from the issuer.

        :return: The approval_code of this ReversefundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def approval_code(self, approval_code):
        """
        Sets the approval_code of this ReversefundstransactionsgetResponse.
        The authorization code from the issuer.

        :param approval_code: The approval_code of this ReversefundstransactionsgetResponse.
        :type: str
        """
    ...
    def fee_program_indicator(self):
        """
        Gets the fee_program_indicator of this ReversefundstransactionsgetResponse.
        

        :return: The fee_program_indicator of this ReversefundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def fee_program_indicator(self, fee_program_indicator):
        """
        Sets the fee_program_indicator of this ReversefundstransactionsgetResponse.
        

        :param fee_program_indicator: The fee_program_indicator of this ReversefundstransactionsgetResponse.
        :type: str
        """
    ...
    def last4of_pan(self):
        """
        Gets the last4of_pan of this ReversefundstransactionsgetResponse.
        This field contains the last four digits of the cardholder primary account number (PAN)

        :return: The last4of_pan of this ReversefundstransactionsgetResponse.
        :rtype: int
        """
    ...
    def last4of_pan(self, last4of_pan):
        """
        Sets the last4of_pan of this ReversefundstransactionsgetResponse.
        This field contains the last four digits of the cardholder primary account number (PAN)

        :param last4of_pan: The last4of_pan of this ReversefundstransactionsgetResponse.
        :type: int
        """
    ...
    def status_identifier(self):
        """
        Gets the status_identifier of this ReversefundstransactionsgetResponse.
        

        :return: The status_identifier of this ReversefundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def status_identifier(self, status_identifier):
        """
        Sets the status_identifier of this ReversefundstransactionsgetResponse.
        

        :param status_identifier: The status_identifier of this ReversefundstransactionsgetResponse.
        :type: str
        """
    ...
    def transaction_identifier(self):
        """
        Gets the transaction_identifier of this ReversefundstransactionsgetResponse.
        ...
        :return: The transaction_identifier of this ReversefundstransactionsgetResponse.
        :rtype: int
        """
    ...
    def transaction_identifier(self, transaction_identifier):
        """
        Sets the transaction_identifier of this ReversefundstransactionsgetResponse.
        The VisaNet reference number for the transaction<br><br><b>Note: </b><br>transactionIdentifier is a Visa generated field that client recieves in the response message.<br><b>Note: </b>As an exception Visa allows clients to use the transactionIdentifier received in the AFT response into the subsequent OCT message - this is to simplify matching the pull and push transaction pair and reconciliation.

        :param transaction_identifier: The transaction_identifier of this ReversefundstransactionsgetResponse.
        :type: int
        """
    ...
    def member_comments(self):
        """
        Gets the member_comments of this ReversefundstransactionsgetResponse.
        ...
        :return: The member_comments of this ReversefundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def member_comments(self, member_comments):
        """
        Sets the member_comments of this ReversefundstransactionsgetResponse.
        This field can be optionally used to send and receive comments by service providers. Issuers can optionally include new text in this field in the response. If the issuer does not include this field, Visa will inject the value from the request in the response and send it back to the service provider.

        :param member_comments: The member_comments of this ReversefundstransactionsgetResponse.
        :type: str
        """
    ...
    def response_code(self):
        """
        Gets the response_code of this ReversefundstransactionsgetResponse.
        ...
        :return: The response_code of this ReversefundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def response_code(self, response_code):
        """
        Sets the response_code of this ReversefundstransactionsgetResponse.
        The source for the response; typically, either the recipient issuer or a Visa system.<br><br>Refer to <a href=\"/request_response_codes#response_code\">responseCode</a><br><b>Note: </b>: The VisaNet Response Source for the transaction

        :param response_code: The response_code of this ReversefundstransactionsgetResponse.
        :type: str
        """
    ...
    def action_code(self):
        """
        Gets the action_code of this ReversefundstransactionsgetResponse.
        ...
        :return: The action_code of this ReversefundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def action_code(self, action_code):
        """
        Sets the action_code of this ReversefundstransactionsgetResponse.
        The results of the transaction request <br><br>Refer to <a href=\"/request_response_codes#action_code\">actionCode</a><br><b>Note: </b>: The VisaNet Response Code for the transaction

        :param action_code: The action_code of this ReversefundstransactionsgetResponse.
        :type: str
        """
    ...
    def transmission_date_time(self):
        """
        Gets the transmission_date_time of this ReversefundstransactionsgetResponse.
        Example: 2016-01-15T07:03:52:000Z

        :return: The transmission_date_time of this ReversefundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def transmission_date_time(self, transmission_date_time):
        """
        Sets the transmission_date_time of this ReversefundstransactionsgetResponse.
        Example: 2016-01-15T07:03:52:000Z

        :param transmission_date_time: The transmission_date_time of this ReversefundstransactionsgetResponse.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ReversefundstransactionsgetResponse):
            return False

...
class PushfundspostPayload(object):
    ...
    def business_application_id(self):
        """
        Gets the business_application_id of this PushfundspostPayload.
        ...
        :return: The business_application_id of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def business_application_id(self, business_application_id):
        """
        Sets the business_application_id of this PushfundspostPayload.
        Identifies the programs' business application type for VisaNet transaction processing<br><br>For Money Transfer, AA applies to transactions where the sender and recipient are the same person and PP applies to transactions where the sender and recipient are not the same person.<br><br>Refer to <a href=\"/request_response_codes#business_application_identifier\">businessApplicationId</a> codes

        :param business_application_id: The business_application_id of this PushfundspostPayload.
        :type: str
        """
    ...
    def retrieval_reference_number(self):
        """
        Gets the retrieval_reference_number of this PushfundspostPayload.
        ...
        :return: The retrieval_reference_number of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def retrieval_reference_number(self, retrieval_reference_number):
        """
        Sets the retrieval_reference_number of this PushfundspostPayload.
        A value used to tie together service calls related to a single financial transaction. When passing Account Funding Transaction (AFT) and an Original Credit Transaction (OCT) methods, this value must differ between the two methods. When passing the Account Funding Transaction Reversal (AFTR) method, this value must match the retrievalReferenceNumber previously passed with the AFT method for this transaction.<br><br> Recommended Format : ydddhhnnnnnn<br><br>The first fours digits must be a valid yddd date in the Julian date format, where the first digit = 0-9 (last digit of current year) and the next three digits = 001-366 (number of the day in the year). hh can be the two digit hour in a 24 hour clock (00-23) during which the transaction is performed.<br><br> nnnnnn can be the systemsTraceAuditNumber or any 6 digit number.

        :param retrieval_reference_number: The retrieval_reference_number of this PushfundspostPayload.
        :type: str
        """
    ...
    def card_acceptor(self):
        """
        Gets the card_acceptor of this PushfundspostPayload.

        :return: The card_acceptor of this PushfundspostPayload.
        :rtype: CardAcceptor
        """
    ...
    def card_acceptor(self, card_acceptor):
        """
        Sets the card_acceptor of this PushfundspostPayload.

        :param card_acceptor: The card_acceptor of this PushfundspostPayload.
        :type: CardAcceptor
        """
    ...
    def message_reason_code(self):
        """
        Gets the message_reason_code of this PushfundspostPayload.
        ...
        :return: The message_reason_code of this PushfundspostPayload.
        :rtype: int
        """
    ...
    def message_reason_code(self, message_reason_code):
        """
        Sets the message_reason_code of this PushfundspostPayload.
        Contains codes that combined with some other fields such as the BAI (Business Application Id) identify some unique use cases. For Sales Tax rebates this field should be populated with the value 5120 (Value-added tax/Sales Tax) along with the businessApplicationId field set to the value 'FD' which indicates this push funds transfer is being conducted in order to facilitate a sales tax refund.

        :param message_reason_code: The message_reason_code of this PushfundspostPayload.
        :type: int
        """
    ...
    def sender_address(self):
        """
        Gets the sender_address of this PushfundspostPayload.
        ...
        :return: The sender_address of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def sender_address(self, sender_address):
        """
        Sets the sender_address of this PushfundspostPayload.
        If the transaction is a money transfer and cross-border or U.S. domestic, this field must contain the sender's address.<br><br>If the transaction is a funds disbursement and cross-border or U.S. domestic, this field must contain either the address of the merchant or government entity sending the funds disbursement.<br><br>If the transaction is a pre-paid load or credit card bill pay and U.S. domestic, this field must contain the sender's address.

        :param sender_address: The sender_address of this PushfundspostPayload.
        :type: str
        """
    ...
    def sender_city(self):
        """
        Gets the sender_city of this PushfundspostPayload.
        ...
        :return: The sender_city of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def sender_city(self, sender_city):
        """
        Sets the sender_city of this PushfundspostPayload.
        If the transaction is a money transfer and cross-border or U.S. domestic, this field must contain the sender's city.<br><br>If the transaction is a funds disbursement and cross-border or U.S. domestic, this field must contain either the city of the merchant or government entity sending the funds disbursement.<br><br>If the transaction is a pre-paid load or credit card bill pay and U.S. domestic, this field must contain the sender's city.

        :param sender_city: The sender_city of this PushfundspostPayload.
        :type: str
        """
    ...
    def source_of_funds_code(self):
        """
        Gets the source_of_funds_code of this PushfundspostPayload.
        ...
        :return: The source_of_funds_code of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def source_of_funds_code(self, source_of_funds_code):
        """
        Sets the source_of_funds_code of this PushfundspostPayload.
        If the transaction is a money transfer, the field is required and must contain a valid <a href=\"/request_response_codes#source_of_funds\">sourceOfFundsCode</a> code that matches the funding instrument.<br><br>If the transaction is a funds disbursement, the field is required and most likely contains a \"05\" as the <a href=\"/request_response_codes#source_of_funds\">sourceOfFundsCode</a> code to identify that the merchant or government entity used a deposit account to fund the disbursement<br><br>If the transaction is a pre-paid load, the field is required if the transaction is non-U.S. domestic.<br><br>If the transaction is a credit bill pay, the field is required if the transaction is non-U.S. domestic, and the <a href=\"/request_response_codes#source_of_funds\">sourceOfFundsCode</a> code must not contain a \"01\" or \"06\".<br><br>Refer to <a href=\"/request_response_codes#source_of_funds\">sourceOfFundsCode</a> codes

        :param source_of_funds_code: The source_of_funds_code of this PushfundspostPayload.
        :type: str
        """
    ...
    def recipient_name(self):
        """
        Gets the recipient_name of this PushfundspostPayload.
        Recipient name is required for cross-border enhanced money transfer OCTs.

        :return: The recipient_name of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def recipient_name(self, recipient_name):
        """
        Sets the recipient_name of this PushfundspostPayload.
        Recipient name is required for cross-border enhanced money transfer OCTs.

        :param recipient_name: The recipient_name of this PushfundspostPayload.
        :type: str
        """
    ...
    def sender_middle_initial(self):
        """
        Gets the sender_middle_initial of this PushfundspostPayload.
        This field contains sender's middle initial

        :return: The sender_middle_initial of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def sender_middle_initial(self, sender_middle_initial):
        """
        Sets the sender_middle_initial of this PushfundspostPayload.
        This field contains sender's middle initial

        :param sender_middle_initial: The sender_middle_initial of this PushfundspostPayload.
        :type: str
        """
    ...
    def sender_name(self):
        """
        Gets the sender_name of this PushfundspostPayload.
        ...
        :return: The sender_name of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def sender_name(self, sender_name):
        """
        Sets the sender_name of this PushfundspostPayload.
        If the transaction is a money transfer and cross-border or U.S. domestic, this field must contain the sender's name.<br><br>If the transaction is a funds disbursement and cross-border or U.S. domestic, this field must contain either the name of the merchant or government entity sending the funds disbursement.<br><br>If the transaction is a pre-paid load or credit card bill pay and U.S. domestic, this field must contain the sender's name.<br><br>Recommended Format: Last Name/Family Surname 1 + Space + Last Name/Family Surname 2 (optional) + Space + First Name/Given Name + Space + Middle Initial or Middle name (optional) + space<br><br>Example: Doe John A

        :param sender_name: The sender_name of this PushfundspostPayload.
        :type: str
        """
    ...
    def recipient_state(self):
        """
        Gets the recipient_state of this PushfundspostPayload.
        Required if RecipientCountryCode is either 124(CAN) or 840(USA) 

        :return: The recipient_state of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def recipient_state(self, recipient_state):
        """
        Sets the recipient_state of this PushfundspostPayload.
        Required if RecipientCountryCode is either 124(CAN) or 840(USA) 

        :param recipient_state: The recipient_state of this PushfundspostPayload.
        :type: str
        """
    ...
    def surcharge(self):
        """
        Gets the surcharge of this PushfundspostPayload.
        ...
        :return: The surcharge of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def surcharge(self, surcharge):
        """
        Sets the surcharge of this PushfundspostPayload.
        When present, this field contains the sender's surcharge as assessed by the originator. Values in this field must be in the same currency and format as defined in the amount field.<br><br><b>Note:</b><br>Supported only in the US.

        :param surcharge: The surcharge of this PushfundspostPayload.
        :type: str
        """
    ...
    def sender_state_code(self):
        """
        Gets the sender_state_code of this PushfundspostPayload.
        Required if senderCountryCode is either 124(CAN) or 840(USA)

        :return: The sender_state_code of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def sender_state_code(self, sender_state_code):
        """
        Sets the sender_state_code of this PushfundspostPayload.
        Required if senderCountryCode is either 124(CAN) or 840(USA)

        :param sender_state_code: The sender_state_code of this PushfundspostPayload.
        :type: str
        """
    ...
    def merchant_category_code(self):
        """
        Gets the merchant_category_code of this PushfundspostPayload.
        ...
        :return: The merchant_category_code of this PushfundspostPayload.
        :rtype: int
        """
    ...
    def merchant_category_code(self, merchant_category_code):
        """
        Sets the merchant_category_code of this PushfundspostPayload.
        If provided, then the value overrides the one present in onboarding data. If the merchantCategoryCode value is not populated in onboarding data then this field is mandatory.<br><br><b>Note:</b> required if not provided during onboarding

        :param merchant_category_code: The merchant_category_code of this PushfundspostPayload.
        :type: int
        """
    ...
    def sender_last_name(self):
        """
        Gets the sender_last_name of this PushfundspostPayload.
        This field contains sender's last name

        :return: The sender_last_name of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def sender_last_name(self, sender_last_name):
        """
        Sets the sender_last_name of this PushfundspostPayload.
        This field contains sender's last name

        :param sender_last_name: The sender_last_name of this PushfundspostPayload.
        :type: str
        """
    ...
    def point_of_service_data(self):
        """
        Gets the point_of_service_data of this PushfundspostPayload.

        :return: The point_of_service_data of this PushfundspostPayload.
    ...
    def point_of_service_data(self, point_of_service_data):
        """
        Sets the point_of_service_data of this PushfundspostPayload.

        :param point_of_service_data: The point_of_service_data of this PushfundspostPayload.
    ...
    def sharing_group_code(self):
        """
        Gets the sharing_group_code of this PushfundspostPayload.
        ...
        :return: The sharing_group_code of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def sharing_group_code(self, sharing_group_code):
        """
        Sets the sharing_group_code of this PushfundspostPayload.
        This field is optionally used by Push Payments Gateway participants (merchants and acquirers) to specify the network access priority.<br><br>Refer to <a href=\"/request_response_codes#network_id_and_sharing_group_code\">Sharing Group Code</a><br><br><b>Note:</b><br>Supported only in US for domestic transactions involving Push Payments Gateway Service.

        :param sharing_group_code: The sharing_group_code of this PushfundspostPayload.
        :type: str
        """
    ...
    def acquirer_country_code(self):
        """
        Gets the acquirer_country_code of this PushfundspostPayload.
        ...
        :return: The acquirer_country_code of this PushfundspostPayload.
        :rtype: int
        """
    ...
    def acquirer_country_code(self, acquirer_country_code):
        """
        Sets the acquirer_country_code of this PushfundspostPayload.
        Use a 3-digit numeric country code for the country of the BIN under which your Visa Direct solution is registered. This must match the information provided during program enrollment.<br><br>Refer to <a href=\"/request_response_codes#iso_country_and_currency_codes\">ISO Codes</a>

        :param acquirer_country_code: The acquirer_country_code of this PushfundspostPayload.
        :type: int
        """
    ...
    def sender_reference(self):
        """
        Gets the sender_reference of this PushfundspostPayload.
        ...
        :return: The sender_reference of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def sender_reference(self, sender_reference):
        """
        Sets the sender_reference of this PushfundspostPayload.
        If the transaction is a money transfer, pre-paid load, or credit card bill pay, and if the sender intends to fund the transaction with a non-financial instrument (for example, cash), a reference number unique to the sender is required.<br><br>If the transaction is a funds disbursement, the field is required.<br><br> This field is required if senderAccountNumber is not sent.

        :param sender_reference: The sender_reference of this PushfundspostPayload.
        :type: str
        """
    ...
    def recipient_primary_account_number(self):
        """
        Gets the recipient_primary_account_number of this PushfundspostPayload.
        The recipient's PAN.

        :return: The recipient_primary_account_number of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def recipient_primary_account_number(self, recipient_primary_account_number):
        """
        Sets the recipient_primary_account_number of this PushfundspostPayload.
        The recipient's PAN.

        :param recipient_primary_account_number: The recipient_primary_account_number of this PushfundspostPayload.
        :type: str
        """
    ...
    def recipient_last_name(self):
        """
        Gets the recipient_last_name of this PushfundspostPayload.
        When present, this field contains recipient's last name

        :return: The recipient_last_name of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def recipient_last_name(self, recipient_last_name):
        """
        Sets the recipient_last_name of this PushfundspostPayload.
        When present, this field contains recipient's last name

        :param recipient_last_name: The recipient_last_name of this PushfundspostPayload.
        :type: str
        """
    ...
    def national_reimbursement_fee(self):
        """
        Gets the national_reimbursement_fee of this PushfundspostPayload.
        When present, this field contains the IRF fees.

        :return: The national_reimbursement_fee of this PushfundspostPayload.
        :rtype: float
        """
    ...
    def national_reimbursement_fee(self, national_reimbursement_fee):
        """
        Sets the national_reimbursement_fee of this PushfundspostPayload.
        When present, this field contains the IRF fees.

        :param national_reimbursement_fee: The national_reimbursement_fee of this PushfundspostPayload.
        :type: float
        """
    ...
    def sender_postal_code(self):
        """
        Gets the sender_postal_code of this PushfundspostPayload.
        When present, this field contains the sender's postal code

        :return: The sender_postal_code of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def sender_postal_code(self, sender_postal_code):
        """
        Sets the sender_postal_code of this PushfundspostPayload.
        When present, this field contains the sender's postal code

        :param sender_postal_code: The sender_postal_code of this PushfundspostPayload.
        :type: str
        """
    ...
    def sender_first_name(self):
        """
        Gets the sender_first_name of this PushfundspostPayload.
        This field contains sender's first name

        :return: The sender_first_name of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def sender_first_name(self, sender_first_name):
        """
        Sets the sender_first_name of this PushfundspostPayload.
        This field contains sender's first name

        :param sender_first_name: The sender_first_name of this PushfundspostPayload.
        :type: str
        """
    ...
    def sender_account_number(self):
        """
        Gets the sender_account_number of this PushfundspostPayload.
        ...
        :return: The sender_account_number of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def sender_account_number(self, sender_account_number):
        """
        Sets the sender_account_number of this PushfundspostPayload.
        If the transaction is a money transfer, pre-paid load, or credit card bill pay, and if the sender intends to fund the transaction with a financial instrument (for example, debit card),  this field is required and must contain the sender's account number. If the transaction is a funds disbursement, the field is not required.

        :param sender_account_number: The sender_account_number of this PushfundspostPayload.
        :type: str
        """
    ...
    def fee_program_indicator(self):
        """
        Gets the fee_program_indicator of this PushfundspostPayload.
        Note: If present, a valid value is required. Spaces or special characters are not allowed.

        :return: The fee_program_indicator of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def fee_program_indicator(self, fee_program_indicator):
        """
        Sets the fee_program_indicator of this PushfundspostPayload.
        Note: If present, a valid value is required. Spaces or special characters are not allowed.

        :param fee_program_indicator: The fee_program_indicator of this PushfundspostPayload.
        :type: str
        """
    ...
    def sender_identification_number_business(self):
        """
        Gets the sender_identification_number_business of this PushfundspostPayload.
        ...
        :return: The sender_identification_number_business of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def sender_identification_number_business(self, sender_identification_number_business):
        """
        Sets the sender_identification_number_business of this PushfundspostPayload.
        This is an alphanumeric value that carries the sender’s identification number issued to the sender by the government or an authorized national entity. This field is to be used if the sender is a business (e.g. Disbursements)

        :param sender_identification_number_business: The sender_identification_number_business of this PushfundspostPayload.
        :type: str
        """
    ...
    def transaction_currency_code(self):
        """
        Gets the transaction_currency_code of this PushfundspostPayload.
        ...
        :return: The transaction_currency_code of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def transaction_currency_code(self, transaction_currency_code):
        """
        Sets the transaction_currency_code of this PushfundspostPayload.
        Use a 3-character alpha or numeric currency code for currency of the sender. You should (unless prohibited by local law / regulation) use the billingCurrencyCode obtained from the Funds Transfer Attribute Inquiry API under Payment Account Attribute Inquiry. <br><br>Refer to <a href=\"/request_response_codes#iso_country_and_currency_codes\">ISO Codes</a> 

        :param transaction_currency_code: The transaction_currency_code of this PushfundspostPayload.
        :type: str
        """
    ...
    def acquiring_bin(self):
        """
        Gets the acquiring_bin of this PushfundspostPayload.
        ...
        :return: The acquiring_bin of this PushfundspostPayload.
        :rtype: int
        """
    ...
    def acquiring_bin(self, acquiring_bin):
        """
        Sets the acquiring_bin of this PushfundspostPayload.
        The Bank Identification Number (BIN) under which the Visa Direct solution is registered. This must match the information provided during enrollment.

        :param acquiring_bin: The acquiring_bin of this PushfundspostPayload.
        :type: int
        """
    ...
    def account_type(self):
        """
        Gets the account_type of this PushfundspostPayload.
        ...
        :return: The account_type of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def account_type(self, account_type):
        """
        Sets the account_type of this PushfundspostPayload.
        This is used to identify the account type of the senderPrimaryAccountNumber in the request. Below are the possible values.<br><br> 00-Not applicable<br> 10-Saving account<br> 20-Checking account<br> 30-Credit card account<br> 40-Universal account<br><br>Default is set to \"00\" if not provided.

        :param account_type: The account_type of this PushfundspostPayload.
        :type: str
        """
    ...
    def merchant_pseudo_aba_number(self):
        """
        Gets the merchant_pseudo_aba_number of this PushfundspostPayload.
        ...
        :return: The merchant_pseudo_aba_number of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def merchant_pseudo_aba_number(self, merchant_pseudo_aba_number):
        """
        Sets the merchant_pseudo_aba_number of this PushfundspostPayload.
        This is a number that uniquely identifies the originator when they sign up to send Push Payment Gateway transactions. On enrollment, an originator will get a single pseudo-value that is assigned by Visa. The other networks will assign their own unique values for the originator.<br><br><b>Note:</b><br>Supported only in US for domestic transactions involving Push Payments Gateway Service.

        :param merchant_pseudo_aba_number: The merchant_pseudo_aba_number of this PushfundspostPayload.
        :type: str
        """
    ...
    def transaction_identifier(self):
        """
        Gets the transaction_identifier of this PushfundspostPayload.
        ...
        :return: The transaction_identifier of this PushfundspostPayload.
        :rtype: int
        """
    ...
    def transaction_identifier(self, transaction_identifier):
        """
        Sets the transaction_identifier of this PushfundspostPayload.
        The VisaNet transaction identifier. If you have previously sent an AFT, this field must include the VisaNet transaction identifier returned in the AFT response.<br><br><b>Note:</b> provide only if there is a corresponding AFT transaction response.

        :param transaction_identifier: The transaction_identifier of this PushfundspostPayload.
        :type: int
        """
    ...
    def local_transaction_date_time(self):
        """
        Gets the local_transaction_date_time of this PushfundspostPayload.
        

        :return: The local_transaction_date_time of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def local_transaction_date_time(self, local_transaction_date_time):
        """
        Sets the local_transaction_date_time of this PushfundspostPayload.
        

        :param local_transaction_date_time: The local_transaction_date_time of this PushfundspostPayload.
        :type: str
        """
    ...
    def recipient_first_name(self):
        """
        Gets the recipient_first_name of this PushfundspostPayload.
        When present, this field contains recipient's first name

        :return: The recipient_first_name of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def recipient_first_name(self, recipient_first_name):
        """
        Sets the recipient_first_name of this PushfundspostPayload.
        When present, this field contains recipient's first name

        :param recipient_first_name: The recipient_first_name of this PushfundspostPayload.
        :type: str
        """
    ...
    def amount(self):
        """
        Gets the amount of this PushfundspostPayload.
        The transaction amount to be delivered to the recipient.

        :return: The amount of this PushfundspostPayload.
        :rtype: float
        """
        return self._amount
    ...
    def amount(self, amount):
        """
        Sets the amount of this PushfundspostPayload.
        The transaction amount to be delivered to the recipient.

        :param amount: The amount of this PushfundspostPayload.
        :type: float
        """
        if amount is None:
    ...
    def sender_date_of_birth(self):
        """
        Gets the sender_date_of_birth of this PushfundspostPayload.
        The birth date for the sender

        :return: The sender_date_of_birth of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def sender_date_of_birth(self, sender_date_of_birth):
        """
        Sets the sender_date_of_birth of this PushfundspostPayload.
        The birth date for the sender

        :param sender_date_of_birth: The sender_date_of_birth of this PushfundspostPayload.
        :type: str
        """
    ...
    def recipient_middle_initial(self):
        """
        Gets the recipient_middle_initial of this PushfundspostPayload.
        When present, this field contains recipient's middle initial

        :return: The recipient_middle_initial of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def recipient_middle_initial(self, recipient_middle_initial):
        """
        Sets the recipient_middle_initial of this PushfundspostPayload.
        When present, this field contains recipient's middle initial

        :param recipient_middle_initial: The recipient_middle_initial of this PushfundspostPayload.
        :type: str
        """
    ...
    def recipient_card_expiry_date(self):
        """
        Gets the recipient_card_expiry_date of this PushfundspostPayload.
        The expiration date for the recipient's primary account number in  recipientPrimaryAccountNumber

        :return: The recipient_card_expiry_date of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def recipient_card_expiry_date(self, recipient_card_expiry_date):
        """
        Sets the recipient_card_expiry_date of this PushfundspostPayload.
        The expiration date for the recipient's primary account number in  recipientPrimaryAccountNumber

        :param recipient_card_expiry_date: The recipient_card_expiry_date of this PushfundspostPayload.
        :type: str
        """
    ...
    def recipient_country_code(self):
        """
        Gets the recipient_country_code of this PushfundspostPayload.
        ...
        :return: The recipient_country_code of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def recipient_country_code(self, recipient_country_code):
        """
        Sets the recipient_country_code of this PushfundspostPayload.
        when present, this field contains recipient's country code <br><br>Refer to <a href=\"/request_response_codes#iso_country_codes\">ISO Codes</a>

        :param recipient_country_code: The recipient_country_code of this PushfundspostPayload.
        :type: str
        """
    ...
    def sender_identification_number_individual(self):
        """
        Gets the sender_identification_number_individual of this PushfundspostPayload.
        ...
        :return: The sender_identification_number_individual of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def sender_identification_number_individual(self, sender_identification_number_individual):
        """
        Sets the sender_identification_number_individual of this PushfundspostPayload.
        This is an alphanumeric value that carries the sender’s identification number issued to the sender by the government or an authorized national entity. This field is to be used if the sender is an Individual (e.g. P2P payments)

        :param sender_identification_number_individual: The sender_identification_number_individual of this PushfundspostPayload.
        :type: str
        """
    ...
    def systems_trace_audit_number(self):
        """
        Gets the systems_trace_audit_number of this PushfundspostPayload.
        ...
        :return: The systems_trace_audit_number of this PushfundspostPayload.
        :rtype: int
        """
    ...
    def systems_trace_audit_number(self, systems_trace_audit_number):
        """
        Sets the systems_trace_audit_number of this PushfundspostPayload.
        A unique value should be used for each API method. However, when passing the (AFTR) method, this value must match the systemsTraceAuditNumber previously passed with the AFT method for the current transaction.

        :param systems_trace_audit_number: The systems_trace_audit_number of this PushfundspostPayload.
        :type: int
        """
    ...
    def sender_country_code(self):
        """
        Gets the sender_country_code of this PushfundspostPayload.
        ...
        :return: The sender_country_code of this PushfundspostPayload.
        :rtype: str
        """
    ...
    def sender_country_code(self, sender_country_code):
        """
        Sets the sender_country_code of this PushfundspostPayload.
        If the transaction is a money transfer and cross-border or U.S. domestic, this field must contain the sender's country code.<br><br>If the transaction is a funds disbursement and cross-border or U.S. domestic, this field must contain either the country code of the merchant or government entity sending the funds disbursement.<br><br>If the transaction is a pre-paid load or credit card bill pay and U.S. domestic, this field must contain the sender's country code.<br><br>Alpha or numeric country code can be supported.<br><br>This field is required when sending the transactions to some of the US debit networks.<br><br>Refer to <a href=\"/request_response_codes#iso_country_and_currency_codes\">ISO Codes</a>

        :param sender_country_code: The sender_country_code of this PushfundspostPayload.
        :type: str
        """
    ...
    def merchant_verification_value(self):
        """
        Gets the merchant_verification_value of this PushfundspostPayload.

        :return: The merchant_verification_value of this PushfundspostPayload.
    ...
    def merchant_verification_value(self, merchant_verification_value):
        """
        Sets the merchant_verification_value of this PushfundspostPayload.

        :param merchant_verification_value: The merchant_verification_value of this PushfundspostPayload.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, PushfundspostPayload):
            return False

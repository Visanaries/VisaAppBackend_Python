...
class MultipushfundstransactionsgetResponse(object):
    """
    ...
    def __init__(self, approval_code=None, fee_program_indicator=None, prepaid_balance=None, prepaid_balance_currency=None, status_identifier=None, transaction_identifier=None, last4of_pan=None, response_code=None, action_code=None, transmission_date_time=None):
        """
        MultipushfundstransactionsgetResponse - a model defined in Swagger
    ...
    def approval_code(self):
        """
        Gets the approval_code of this MultipushfundstransactionsgetResponse.
        The authorization code from the issuer.

        :return: The approval_code of this MultipushfundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def approval_code(self, approval_code):
        """
        Sets the approval_code of this MultipushfundstransactionsgetResponse.
        The authorization code from the issuer.

        :param approval_code: The approval_code of this MultipushfundstransactionsgetResponse.
        :type: str
        """
    ...
    def fee_program_indicator(self):
        """
        Gets the fee_program_indicator of this MultipushfundstransactionsgetResponse.
        

        :return: The fee_program_indicator of this MultipushfundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def fee_program_indicator(self, fee_program_indicator):
        """
        Sets the fee_program_indicator of this MultipushfundstransactionsgetResponse.
        

        :param fee_program_indicator: The fee_program_indicator of this MultipushfundstransactionsgetResponse.
        :type: str
        """
    ...
    def prepaid_balance(self):
        """
        Gets the prepaid_balance of this MultipushfundstransactionsgetResponse.
        Min Inclusive: -999999999.999<br><br>Max Inclusive: 999999999.999<br><br>Applicable only for Top Up Transactions

        :return: The prepaid_balance of this MultipushfundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def prepaid_balance(self, prepaid_balance):
        """
        Sets the prepaid_balance of this MultipushfundstransactionsgetResponse.
        Min Inclusive: -999999999.999<br><br>Max Inclusive: 999999999.999<br><br>Applicable only for Top Up Transactions

        :param prepaid_balance: The prepaid_balance of this MultipushfundstransactionsgetResponse.
        :type: str
        """
    ...
    def prepaid_balance_currency(self):
        """
        Gets the prepaid_balance_currency of this MultipushfundstransactionsgetResponse.
        

        :return: The prepaid_balance_currency of this MultipushfundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def prepaid_balance_currency(self, prepaid_balance_currency):
        """
        Sets the prepaid_balance_currency of this MultipushfundstransactionsgetResponse.
        

        :param prepaid_balance_currency: The prepaid_balance_currency of this MultipushfundstransactionsgetResponse.
        :type: str
        """
    ...
    def status_identifier(self):
        """
        Gets the status_identifier of this MultipushfundstransactionsgetResponse.
        required when call times out

        :return: The status_identifier of this MultipushfundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def status_identifier(self, status_identifier):
        """
        Sets the status_identifier of this MultipushfundstransactionsgetResponse.
        required when call times out

        :param status_identifier: The status_identifier of this MultipushfundstransactionsgetResponse.
        :type: str
        """
    ...
    def transaction_identifier(self):
        """
        Gets the transaction_identifier of this MultipushfundstransactionsgetResponse.
        ...
        :return: The transaction_identifier of this MultipushfundstransactionsgetResponse.
        :rtype: int
        """
    ...
    def transaction_identifier(self, transaction_identifier):
        """
        Sets the transaction_identifier of this MultipushfundstransactionsgetResponse.
        The VisaNet reference number for the transaction<br><br><b>Note: </b><br>transactionIdentifier is a Visa generated field that client recieves in the response message.<br><b>Note: </b>As an exception Visa allows clients to use the transactionIdentifier received in the AFT response into the subsequent OCT message - this is to simplify matching the pull and push transaction pair and reconciliation.

        :param transaction_identifier: The transaction_identifier of this MultipushfundstransactionsgetResponse.
        :type: int
        """
    ...
    def last4of_pan(self):
        """
        Gets the last4of_pan of this MultipushfundstransactionsgetResponse.
        This field contains the last four digits of the cardholder primary account number (PAN)

        :return: The last4of_pan of this MultipushfundstransactionsgetResponse.
        :rtype: int
        """
    ...
    def last4of_pan(self, last4of_pan):
        """
        Sets the last4of_pan of this MultipushfundstransactionsgetResponse.
        This field contains the last four digits of the cardholder primary account number (PAN)

        :param last4of_pan: The last4of_pan of this MultipushfundstransactionsgetResponse.
        :type: int
        """
    ...
    def response_code(self):
        """
        Gets the response_code of this MultipushfundstransactionsgetResponse.
        ...
        :return: The response_code of this MultipushfundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def response_code(self, response_code):
        """
        Sets the response_code of this MultipushfundstransactionsgetResponse.
        The source for the response; typically, either the recipient issuer or a Visa system.<br><br>Refer to <a href=\"/request_response_codes#response_code\">responseCode</a><br><b>Note: </b>: The VisaNet Response Source for the transaction

        :param response_code: The response_code of this MultipushfundstransactionsgetResponse.
        :type: str
        """
    ...
    def action_code(self):
        """
        Gets the action_code of this MultipushfundstransactionsgetResponse.
        ...
        :return: The action_code of this MultipushfundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def action_code(self, action_code):
        """
        Sets the action_code of this MultipushfundstransactionsgetResponse.
        The results of the transaction request <br><br>Refer to <a href=\"/request_response_codes#action_code\">Action Code</a><br><b>Note: </b>: The VisaNet Response Code for the transaction

        :param action_code: The action_code of this MultipushfundstransactionsgetResponse.
        :type: str
        """
    ...
    def transmission_date_time(self):
        """
        Gets the transmission_date_time of this MultipushfundstransactionsgetResponse.
        Example: 2016-01-15T07:03:52.000Z

        :return: The transmission_date_time of this MultipushfundstransactionsgetResponse.
        :rtype: str
        """
    ...
    def transmission_date_time(self, transmission_date_time):
        """
        Sets the transmission_date_time of this MultipushfundstransactionsgetResponse.
        Example: 2016-01-15T07:03:52.000Z

        :param transmission_date_time: The transmission_date_time of this MultipushfundstransactionsgetResponse.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, MultipushfundstransactionsgetResponse):
            return False

...
class MultireversefundspostResponse(object):
    """
    ...
    def __init__(self, network_id=None, merchant_verification_value=None, member_comments=None, status_identifier=None):
        """
        MultireversefundspostResponse - a model defined in Swagger
    ...
    def network_id(self):
        """
        Gets the network_id of this MultireversefundspostResponse.
        ...
        :return: The network_id of this MultireversefundspostResponse.
        :rtype: int
        """
    ...
    def network_id(self, network_id):
        """
        Sets the network_id of this MultireversefundspostResponse.
        This contains a code that identifies the network on which the transaction was processed.<br><br>Refer to <a href=\"/request_response_codes#network_id_and_sharing_group_code\">Network ID</a><br><br><b>Note:</b><br>This field is returned only if it is anything other than networkId value 2.<br><br>Supported only in US for domestic transactions.

        :param network_id: The network_id of this MultireversefundspostResponse.
        :type: int
        """
    ...
    def merchant_verification_value(self):
        """
        Gets the merchant_verification_value of this MultireversefundspostResponse.
        The concatenated Merchant Verification Value of Visa assigned and Acquirer assigned value is returned.

        :return: The merchant_verification_value of this MultireversefundspostResponse.
        :rtype: str
        """
    ...
    def merchant_verification_value(self, merchant_verification_value):
        """
        Sets the merchant_verification_value of this MultireversefundspostResponse.
        The concatenated Merchant Verification Value of Visa assigned and Acquirer assigned value is returned.

        :param merchant_verification_value: The merchant_verification_value of this MultireversefundspostResponse.
        :type: str
        """
    ...
    def member_comments(self):
        """
        Gets the member_comments of this MultireversefundspostResponse.
        ...
        :return: The member_comments of this MultireversefundspostResponse.
        :rtype: str
        """
    ...
    def member_comments(self, member_comments):
        """
        Sets the member_comments of this MultireversefundspostResponse.
        This field can be optionally used to send and receive comments by service providers. Issuers can optionally include new text in this field in the response. If the issuer does not include this field, Visa will inject the value from the request in the response and send it back to the service provider.

        :param member_comments: The member_comments of this MultireversefundspostResponse.
        :type: str
        """
    ...
    def status_identifier(self):
        """
        Gets the status_identifier of this MultireversefundspostResponse.
        

        :return: The status_identifier of this MultireversefundspostResponse.
        :rtype: str
        """
    ...
    def status_identifier(self, status_identifier):
        """
        Sets the status_identifier of this MultireversefundspostResponse.
        

        :param status_identifier: The status_identifier of this MultireversefundspostResponse.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, MultireversefundspostResponse):
            return False

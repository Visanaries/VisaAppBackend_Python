...
class CashInPushPaymentspostPayload(object):
    """
    ...
    def __init__(self, local_transaction_date_time=None, acquiring_bin=None, business_application_id=None, merchant_category_code=None, card_acceptor=None, acquirer_country_code=None, retrieval_reference_number=None, amount=None, sender_reference=None, recipient_primary_account_number=None, systems_trace_audit_number=None, sender_account_number=None, transaction_currency_code=None, sender_name=None):
        """
        CashInPushPaymentspostPayload - a model defined in Swagger
    ...
    def local_transaction_date_time(self):
        """
        Gets the local_transaction_date_time of this CashInPushPaymentspostPayload.
        The date and time the transaction takes place, expressed in the local date and time of the originator.

        :return: The local_transaction_date_time of this CashInPushPaymentspostPayload.
        :rtype: str
        """
    ...
    def local_transaction_date_time(self, local_transaction_date_time):
        """
        Sets the local_transaction_date_time of this CashInPushPaymentspostPayload.
        The date and time the transaction takes place, expressed in the local date and time of the originator.

        :param local_transaction_date_time: The local_transaction_date_time of this CashInPushPaymentspostPayload.
        :type: str
        """
    ...
    def acquiring_bin(self):
        """
        Gets the acquiring_bin of this CashInPushPaymentspostPayload.
        BIN number identifies the originator of cash-in transaction.

        :return: The acquiring_bin of this CashInPushPaymentspostPayload.
        :rtype: str
        """
    ...
    def acquiring_bin(self, acquiring_bin):
        """
        Sets the acquiring_bin of this CashInPushPaymentspostPayload.
        BIN number identifies the originator of cash-in transaction.

        :param acquiring_bin: The acquiring_bin of this CashInPushPaymentspostPayload.
        :type: str
        """
    ...
    def business_application_id(self):
        """
        Gets the business_application_id of this CashInPushPaymentspostPayload.
        Use CI (cash-in). This field is populated with business application identifier for the transaction. Refer to <a href=\"/request_response_codes#business_application_identifier\">businessApplicationID</a> codes

        :return: The business_application_id of this CashInPushPaymentspostPayload.
        :rtype: str
        """
    ...
    def business_application_id(self, business_application_id):
        """
        Sets the business_application_id of this CashInPushPaymentspostPayload.
        Use CI (cash-in). This field is populated with business application identifier for the transaction. Refer to <a href=\"/request_response_codes#business_application_identifier\">businessApplicationID</a> codes

        :param business_application_id: The business_application_id of this CashInPushPaymentspostPayload.
        :type: str
        """
    ...
    def merchant_category_code(self):
        """
        Gets the merchant_category_code of this CashInPushPaymentspostPayload.
        ...
        :return: The merchant_category_code of this CashInPushPaymentspostPayload.
        :rtype: str
        """
    ...
    def merchant_category_code(self, merchant_category_code):
        """
        Sets the merchant_category_code of this CashInPushPaymentspostPayload.
        Numeric only. Originators should populate 6012. If this field is not populated by the originator, it will automatically be set to the MCC value indicated during the API onboarding process. Recipient should populate the MCC of the merchant in the response message.

        :param merchant_category_code: The merchant_category_code of this CashInPushPaymentspostPayload.
        :type: str
        """
    ...
    def card_acceptor(self):
        """
        Gets the card_acceptor of this CashInPushPaymentspostPayload.

        :return: The card_acceptor of this CashInPushPaymentspostPayload.
        :rtype: CardAcceptor
        """
    ...
    def card_acceptor(self, card_acceptor):
        """
        Sets the card_acceptor of this CashInPushPaymentspostPayload.

        :param card_acceptor: The card_acceptor of this CashInPushPaymentspostPayload.
        :type: CardAcceptor
        """
    ...
    def acquirer_country_code(self):
        """
        Gets the acquirer_country_code of this CashInPushPaymentspostPayload.
        ...
        :return: The acquirer_country_code of this CashInPushPaymentspostPayload.
        :rtype: str
        """
    ...
    def acquirer_country_code(self, acquirer_country_code):
        """
        Sets the acquirer_country_code of this CashInPushPaymentspostPayload.
        Use a 3-digit numeric country code for the country where the Visa Direct solution is registered. This must match the information provided during program enrollment. Refer to <a href=\"/request_response_codes#iso_country_codes\">ISO Codes</a>.

        :param acquirer_country_code: The acquirer_country_code of this CashInPushPaymentspostPayload.
        :type: str
        """
    ...
    def retrieval_reference_number(self):
        """
        Gets the retrieval_reference_number of this CashInPushPaymentspostPayload.
        ...
        :return: The retrieval_reference_number of this CashInPushPaymentspostPayload.
        :rtype: str
        """
    ...
    def retrieval_reference_number(self, retrieval_reference_number):
        """
        Sets the retrieval_reference_number of this CashInPushPaymentspostPayload.
        Numeric only. Key data element for matching a message to others within a given transaction set. The same number appears in all related messages: response, advice, reversal, chargeback, chargeback reversal, or representment. It is recommended that the client populate ydddhhnnnnnn value in this field.

        :param retrieval_reference_number: The retrieval_reference_number of this CashInPushPaymentspostPayload.
        :type: str
        """
    ...
    def amount(self):
        """
        Gets the amount of this CashInPushPaymentspostPayload.
        Transaction amount in merchant currency. Visa's rules do not permit cross border cash deposit transactions.

        :return: The amount of this CashInPushPaymentspostPayload.
        :rtype: str
        """
        return self._amount
    ...
    def amount(self, amount):
        """
        Sets the amount of this CashInPushPaymentspostPayload.
        Transaction amount in merchant currency. Visa's rules do not permit cross border cash deposit transactions.

        :param amount: The amount of this CashInPushPaymentspostPayload.
        :type: str
        """
        if amount is None:
    ...
    def sender_reference(self):
        """
        Gets the sender_reference of this CashInPushPaymentspostPayload.
        A reference number unique to the merchant. Field can be left blank.

        :return: The sender_reference of this CashInPushPaymentspostPayload.
        :rtype: str
        """
    ...
    def sender_reference(self, sender_reference):
        """
        Sets the sender_reference of this CashInPushPaymentspostPayload.
        A reference number unique to the merchant. Field can be left blank.

        :param sender_reference: The sender_reference of this CashInPushPaymentspostPayload.
        :type: str
        """
    ...
    def recipient_primary_account_number(self):
        """
        Gets the recipient_primary_account_number of this CashInPushPaymentspostPayload.
        Consumer PAN. 16-digit PAN as provided by the consumer to merchant.

        :return: The recipient_primary_account_number of this CashInPushPaymentspostPayload.
        :rtype: str
        """
    ...
    def recipient_primary_account_number(self, recipient_primary_account_number):
        """
        Sets the recipient_primary_account_number of this CashInPushPaymentspostPayload.
        Consumer PAN. 16-digit PAN as provided by the consumer to merchant.

        :param recipient_primary_account_number: The recipient_primary_account_number of this CashInPushPaymentspostPayload.
        :type: str
        """
    ...
    def systems_trace_audit_number(self):
        """
        Gets the systems_trace_audit_number of this CashInPushPaymentspostPayload.
        ...
        :return: The systems_trace_audit_number of this CashInPushPaymentspostPayload.
        :rtype: str
        """
    ...
    def systems_trace_audit_number(self, systems_trace_audit_number):
        """
        Sets the systems_trace_audit_number of this CashInPushPaymentspostPayload.
        Numeric only. It is a key data element used to match a response to its request or to match a message to others for a given transaction. The value assigned to the original request should appear in all subsequent messages for that transaction

        :param systems_trace_audit_number: The systems_trace_audit_number of this CashInPushPaymentspostPayload.
        :type: str
        """
    ...
    def sender_account_number(self):
        """
        Gets the sender_account_number of this CashInPushPaymentspostPayload.
        This is optional field for cash-in transactions.

        :return: The sender_account_number of this CashInPushPaymentspostPayload.
        :rtype: str
        """
    ...
    def sender_account_number(self, sender_account_number):
        """
        Sets the sender_account_number of this CashInPushPaymentspostPayload.
        This is optional field for cash-in transactions.

        :param sender_account_number: The sender_account_number of this CashInPushPaymentspostPayload.
        :type: str
        """
    ...
    def transaction_currency_code(self):
        """
        Gets the transaction_currency_code of this CashInPushPaymentspostPayload.
        The code in this field must always reflect the currency associated to the amount in field Amount. Use a 3-digit numeric currency code for transaction currency. Refer to <a href=\"/request_response_codes#currency_codes\">ISO Codes</a>.

        :return: The transaction_currency_code of this CashInPushPaymentspostPayload.
        :rtype: str
        """
    ...
    def transaction_currency_code(self, transaction_currency_code):
        """
        Sets the transaction_currency_code of this CashInPushPaymentspostPayload.
        The code in this field must always reflect the currency associated to the amount in field Amount. Use a 3-digit numeric currency code for transaction currency. Refer to <a href=\"/request_response_codes#currency_codes\">ISO Codes</a>.

        :param transaction_currency_code: The transaction_currency_code of this CashInPushPaymentspostPayload.
        :type: str
        """
    ...
    def sender_name(self):
        """
        Gets the sender_name of this CashInPushPaymentspostPayload.
        ...
        :return: The sender_name of this CashInPushPaymentspostPayload.
        :rtype: str
        """
    ...
    def sender_name(self, sender_name):
        """
        Sets the sender_name of this CashInPushPaymentspostPayload.
        Populate the field with merchant’s doing business as name (25 characters only). If the name is greater than 25 characters, use the first 25 characters. The name must be populated using the Roman i.e. English character set.

        :param sender_name: The sender_name of this CashInPushPaymentspostPayload.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CashInPushPaymentspostPayload):
            return False

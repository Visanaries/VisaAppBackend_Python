...
class CashInPushPaymentsGetgetResponse(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, approval_code=None, transaction_identifier=None, status_identifier=None, retrieval_reference_number=None, response_code=None, action_code=None, transaction_date_time=None):
        """
        CashInPushPaymentsGetgetResponse - a model defined in Swagger
    ...
    def approval_code(self):
        """
        Gets the approval_code of this CashInPushPaymentsGetgetResponse.
        <b>Conditional.</b> Contains the authorization code provided by the participant when a transaction is approved.

        :return: The approval_code of this CashInPushPaymentsGetgetResponse.
        :rtype: str
        """
    ...
    def approval_code(self, approval_code):
        """
        Sets the approval_code of this CashInPushPaymentsGetgetResponse.
        <b>Conditional.</b> Contains the authorization code provided by the participant when a transaction is approved.

        :param approval_code: The approval_code of this CashInPushPaymentsGetgetResponse.
        :type: str
        """
    ...
    def transaction_identifier(self):
        """
        Gets the transaction_identifier of this CashInPushPaymentsGetgetResponse.
        ...
        :return: The transaction_identifier of this CashInPushPaymentsGetgetResponse.
        :rtype: str
        """
    ...
    def transaction_identifier(self, transaction_identifier):
        """
        Sets the transaction_identifier of this CashInPushPaymentsGetgetResponse.
        It is added by VisaNet. It contains a right-justified, VisaNet generated Transaction Identifier (TID) that is unique for each request. The identifier links original messages to subsequent messages, such as those for exception item processing and clearing record.

        :param transaction_identifier: The transaction_identifier of this CashInPushPaymentsGetgetResponse.
        :type: str
        """
    ...
    def status_identifier(self):
        """
        Gets the status_identifier of this CashInPushPaymentsGetgetResponse.
        Required when the API response times out.

        :return: The status_identifier of this CashInPushPaymentsGetgetResponse.
        :rtype: str
        """
    ...
    def status_identifier(self, status_identifier):
        """
        Sets the status_identifier of this CashInPushPaymentsGetgetResponse.
        Required when the API response times out.

        :param status_identifier: The status_identifier of this CashInPushPaymentsGetgetResponse.
        :type: str
        """
    ...
    def retrieval_reference_number(self):
        """
        Gets the retrieval_reference_number of this CashInPushPaymentsGetgetResponse.
        ...
        :return: The retrieval_reference_number of this CashInPushPaymentsGetgetResponse.
        :rtype: str
        """
    ...
    def retrieval_reference_number(self, retrieval_reference_number):
        """
        Sets the retrieval_reference_number of this CashInPushPaymentsGetgetResponse.
        Numeric only. Key data element for matching a message to others within a given transaction set. Value will be the same as what has been provided in the request.

        :param retrieval_reference_number: The retrieval_reference_number of this CashInPushPaymentsGetgetResponse.
        :type: str
        """
    ...
    def response_code(self):
        """
        Gets the response_code of this CashInPushPaymentsGetgetResponse.
        ...
        :return: The response_code of this CashInPushPaymentsGetgetResponse.
        :rtype: str
        """
    ...
    def response_code(self, response_code):
        """
        Sets the response_code of this CashInPushPaymentsGetgetResponse.
        It is added by VisaNet and contains the response source/reason code that identifies the source of the field actionCode response decision.

        :param response_code: The response_code of this CashInPushPaymentsGetgetResponse.
        :type: str
        """
    ...
    def action_code(self):
        """
        Gets the action_code of this CashInPushPaymentsGetgetResponse.
        Contains a code that defines the response to a request. Refer to <a href=\"/request_response_codes#action_code\">ActionCode</a>

        :return: The action_code of this CashInPushPaymentsGetgetResponse.
        :rtype: str
        """
    ...
    def action_code(self, action_code):
        """
        Sets the action_code of this CashInPushPaymentsGetgetResponse.
        Contains a code that defines the response to a request. Refer to <a href=\"/request_response_codes#action_code\">ActionCode</a>

        :param action_code: The action_code of this CashInPushPaymentsGetgetResponse.
        :type: str
        """
    ...
    def transaction_date_time(self):
        """
        Gets the transaction_date_time of this CashInPushPaymentsGetgetResponse.
        The value in response must match the value in the request.

        :return: The transaction_date_time of this CashInPushPaymentsGetgetResponse.
        :rtype: str
        """
    ...
    def transaction_date_time(self, transaction_date_time):
        """
        Sets the transaction_date_time of this CashInPushPaymentsGetgetResponse.
        The value in response must match the value in the request.

        :param transaction_date_time: The transaction_date_time of this CashInPushPaymentsGetgetResponse.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CashInPushPaymentsGetgetResponse):
            return False

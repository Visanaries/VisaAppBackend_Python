...
class CashInPushPaymentspostResponse(object):
    """
    ...
    def __init__(self, approval_code=None, transaction_identifier=None, status_identifier=None, retrieval_reference_number=None, response_code=None, action_code=None, transaction_date_time=None):
        """
        CashInPushPaymentspostResponse - a model defined in Swagger
    ...
    def approval_code(self):
        """
        Gets the approval_code of this CashInPushPaymentspostResponse.
        <b>Conditional.</b> Contains the authorization code provided by the participant when a transaction is approved.

        :return: The approval_code of this CashInPushPaymentspostResponse.
        :rtype: str
        """
    ...
    def approval_code(self, approval_code):
        """
        Sets the approval_code of this CashInPushPaymentspostResponse.
        <b>Conditional.</b> Contains the authorization code provided by the participant when a transaction is approved.

        :param approval_code: The approval_code of this CashInPushPaymentspostResponse.
        :type: str
        """
    ...
    def transaction_identifier(self):
        """
        Gets the transaction_identifier of this CashInPushPaymentspostResponse.
        ...
        :return: The transaction_identifier of this CashInPushPaymentspostResponse.
        :rtype: str
        """
    ...
    def transaction_identifier(self, transaction_identifier):
        """
        Sets the transaction_identifier of this CashInPushPaymentspostResponse.
        It is added by VisaNet. It contains a right-justified, VisaNet generated Transaction Identifier (TID) that is unique for each request. The identifier links original messages to subsequent messages, such as those for exception item processing and clearing record.

        :param transaction_identifier: The transaction_identifier of this CashInPushPaymentspostResponse.
        :type: str
        """
    ...
    def status_identifier(self):
        """
        Gets the status_identifier of this CashInPushPaymentspostResponse.
        Required when the API response times out.

        :return: The status_identifier of this CashInPushPaymentspostResponse.
        :rtype: str
        """
    ...
    def status_identifier(self, status_identifier):
        """
        Sets the status_identifier of this CashInPushPaymentspostResponse.
        Required when the API response times out.

        :param status_identifier: The status_identifier of this CashInPushPaymentspostResponse.
        :type: str
        """
    ...
    def retrieval_reference_number(self):
        """
        Gets the retrieval_reference_number of this CashInPushPaymentspostResponse.
        ...
        :return: The retrieval_reference_number of this CashInPushPaymentspostResponse.
        :rtype: str
        """
    ...
    def retrieval_reference_number(self, retrieval_reference_number):
        """
        Sets the retrieval_reference_number of this CashInPushPaymentspostResponse.
        Numeric only. Key data element for matching a message to others within a given transaction set. Value will be the same as what has been provided in the request.

        :param retrieval_reference_number: The retrieval_reference_number of this CashInPushPaymentspostResponse.
        :type: str
        """
    ...
    def response_code(self):
        """
        Gets the response_code of this CashInPushPaymentspostResponse.
        ...
        :return: The response_code of this CashInPushPaymentspostResponse.
        :rtype: str
        """
    ...
    def response_code(self, response_code):
        """
        Sets the response_code of this CashInPushPaymentspostResponse.
        It is added by VisaNet and contains the response source/reason code that identifies the source of the field actionCode response decision.

        :param response_code: The response_code of this CashInPushPaymentspostResponse.
        :type: str
        """
    ...
    def action_code(self):
        """
        Gets the action_code of this CashInPushPaymentspostResponse.
        Contains a code that defines the response to a request. Refer to <a href=\"/request_response_codes#action_code\">ActionCode</a>

        :return: The action_code of this CashInPushPaymentspostResponse.
        :rtype: str
        """
    ...
    def action_code(self, action_code):
        """
        Sets the action_code of this CashInPushPaymentspostResponse.
        Contains a code that defines the response to a request. Refer to <a href=\"/request_response_codes#action_code\">ActionCode</a>

        :param action_code: The action_code of this CashInPushPaymentspostResponse.
        :type: str
        """
    ...
    def transaction_date_time(self):
        """
        Gets the transaction_date_time of this CashInPushPaymentspostResponse.
        The value in response must match the value in the request.

        :return: The transaction_date_time of this CashInPushPaymentspostResponse.
        :rtype: str
        """
    ...
    def transaction_date_time(self, transaction_date_time):
        """
        Sets the transaction_date_time of this CashInPushPaymentspostResponse.
        The value in response must match the value in the request.

        :param transaction_date_time: The transaction_date_time of this CashInPushPaymentspostResponse.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CashInPushPaymentspostResponse):
            return False

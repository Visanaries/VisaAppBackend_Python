...
class CreateMerchantAliaspostPayload(object):
    ...
    def city(self):
        """
        Gets the city of this CreateMerchantAliaspostPayload.
        Merchant or agent city.

        :return: The city of this CreateMerchantAliaspostPayload.
        :rtype: str
        """
        return self._city
    ...
    def city(self, city):
        """
        Sets the city of this CreateMerchantAliaspostPayload.
        Merchant or agent city.

        :param city: The city of this CreateMerchantAliaspostPayload.
        :type: str
        """
        if city is None:
    ...
    def merchant_category_code(self):
        """
        Gets the merchant_category_code of this CreateMerchantAliaspostPayload.
        Merchant Category Code. Numeric only.

        :return: The merchant_category_code of this CreateMerchantAliaspostPayload.
        :rtype: str
        """
    ...
    def merchant_category_code(self, merchant_category_code):
        """
        Sets the merchant_category_code of this CreateMerchantAliaspostPayload.
        Merchant Category Code. Numeric only.

        :param merchant_category_code: The merchant_category_code of this CreateMerchantAliaspostPayload.
        :type: str
        """
    ...
    def payload_format_indicator(self):
        """
        Gets the payload_format_indicator of this CreateMerchantAliaspostPayload.
        ...
        :return: The payload_format_indicator of this CreateMerchantAliaspostPayload.
        :rtype: str
        """
    ...
    def payload_format_indicator(self, payload_format_indicator):
        """
        Sets the payload_format_indicator of this CreateMerchantAliaspostPayload.
        Defines the format of the merchant data payload. Payload Format Indicator must be set to '01' as per EMVCo Merchant Presented QR specifications.

        :param payload_format_indicator: The payload_format_indicator of this CreateMerchantAliaspostPayload.
        :type: str
        """
    ...
    def transaction_currency_code(self):
        """
        Gets the transaction_currency_code of this CreateMerchantAliaspostPayload.
        ...
        :return: The transaction_currency_code of this CreateMerchantAliaspostPayload.
        :rtype: str
        """
    ...
    def transaction_currency_code(self, transaction_currency_code):
        """
        Sets the transaction_currency_code of this CreateMerchantAliaspostPayload.
        As defined by ISO 4217.  This is the transaction currency code that a merchant can accept for payment. 3-digit numeric presentation of the currency is recommended to be used if alias may be used for QR.

        :param transaction_currency_code: The transaction_currency_code of this CreateMerchantAliaspostPayload.
        :type: str
        """
    ...
    def recipient_name(self):
        """
        Gets the recipient_name of this CreateMerchantAliaspostPayload.
        Merchant or agent name.

        :return: The recipient_name of this CreateMerchantAliaspostPayload.
        :rtype: str
        """
    ...
    def recipient_name(self, recipient_name):
        """
        Sets the recipient_name of this CreateMerchantAliaspostPayload.
        Merchant or agent name.

        :param recipient_name: The recipient_name of this CreateMerchantAliaspostPayload.
        :type: str
        """
    ...
    def country(self):
        """
        Gets the country of this CreateMerchantAliaspostPayload.
        ...
        :return: The country of this CreateMerchantAliaspostPayload.
        :rtype: str
        """
    ...
    def country(self, country):
        """
        Sets the country of this CreateMerchantAliaspostPayload.
        Merchant or agent country code as defined by ISO 3166. ISO 3166 alpha-2 is recommended to be used if alias may be used for QR.

        :param country: The country of this CreateMerchantAliaspostPayload.
        :type: str
        """
        if country is None:
    ...
    def convenience_fee_amount(self):
        """
        Gets the convenience_fee_amount of this CreateMerchantAliaspostPayload.
        The convenience fee of a fixed amount. Applicable only for merchant alias.

        :return: The convenience_fee_amount of this CreateMerchantAliaspostPayload.
        :rtype: str
        """
    ...
    def convenience_fee_amount(self, convenience_fee_amount):
        """
        Sets the convenience_fee_amount of this CreateMerchantAliaspostPayload.
        The convenience fee of a fixed amount. Applicable only for merchant alias.

        :param convenience_fee_amount: The convenience_fee_amount of this CreateMerchantAliaspostPayload.
        :type: str
        """
    ...
    def is_agent_alias(self):
        """
        Gets the is_agent_alias of this CreateMerchantAliaspostPayload.
        Optional and applicable for agent alias use only. If set as 'Y', agent alias to be created.

        :return: The is_agent_alias of this CreateMerchantAliaspostPayload.
        :rtype: str
        """
    ...
    def is_agent_alias(self, is_agent_alias):
        """
        Sets the is_agent_alias of this CreateMerchantAliaspostPayload.
        Optional and applicable for agent alias use only. If set as 'Y', agent alias to be created.

        :param is_agent_alias: The is_agent_alias of this CreateMerchantAliaspostPayload.
        :type: str
        """
    ...
    def point_of_initiation_method(self):
        """
        Gets the point_of_initiation_method of this CreateMerchantAliaspostPayload.
        ...
        :return: The point_of_initiation_method of this CreateMerchantAliaspostPayload.
        :rtype: str
        """
    ...
    def point_of_initiation_method(self, point_of_initiation_method):
        """
        Sets the point_of_initiation_method of this CreateMerchantAliaspostPayload.
        In this two-digit field, the first character indicates the method by which the data is presented by the merchant. The second character indicates whether the data is static or dynamic. Static data refers to a situation wherein same data is presented for every transaction unlike a dynamic data wherein the information is specific to a transaction.<br><b>1st character</b><br>''1'' = QR<br>''2'' = BLE<br>''3'' = NFC<br>''4'' - ''9'' = Reserved for Future Use<br><b>2nd character</b><br>''1'' = Static<br>''2'' = Dynamic<br>''3'' - ''9'' = Reserved for Future Use.<br>Example: ''11'' indicates QR static code, ''12'' indicates QR dynamic code.

        :param point_of_initiation_method: The point_of_initiation_method of this CreateMerchantAliaspostPayload.
        :type: str
        """
    ...
    def tip_convenience_fee_indicator(self):
        """
        Gets the tip_convenience_fee_indicator of this CreateMerchantAliaspostPayload.
        ...
        :return: The tip_convenience_fee_indicator of this CreateMerchantAliaspostPayload.
        :rtype: str
        """
    ...
    def tip_convenience_fee_indicator(self, tip_convenience_fee_indicator):
        """
        Sets the tip_convenience_fee_indicator of this CreateMerchantAliaspostPayload.
        Tip or Convenience Fee Indicator. This shall contains a value of '01', '02' or '03' as per EMVCo Merchant Presented QR specifications. Applicable only for merchant alias.

        :param tip_convenience_fee_indicator: The tip_convenience_fee_indicator of this CreateMerchantAliaspostPayload.
        :type: str
        """
    ...
    def convenience_fee_percentage(self):
        """
        Gets the convenience_fee_percentage of this CreateMerchantAliaspostPayload.
        ...
        :return: The convenience_fee_percentage of this CreateMerchantAliaspostPayload.
        :rtype: str
        """
    ...
    def convenience_fee_percentage(self, convenience_fee_percentage):
        """
        Sets the convenience_fee_percentage of this CreateMerchantAliaspostPayload.
        Applicable only for merchant alias. The percentage convenience fee, specified as numeric value from “00.01” (for 00.01%) to “99.99” (for 99.99%).

        :param convenience_fee_percentage: The convenience_fee_percentage of this CreateMerchantAliaspostPayload.
        :type: str
        """
    ...
    def alias_id(self):
        """
        Gets the alias_id of this CreateMerchantAliaspostPayload.
        This attribute is used by acquirer to uniquely identify their merchant or agent.

        :return: The alias_id of this CreateMerchantAliaspostPayload.
        :rtype: str
        """
    ...
    def alias_id(self, alias_id):
        """
        Sets the alias_id of this CreateMerchantAliaspostPayload.
        This attribute is used by acquirer to uniquely identify their merchant or agent.

        :param alias_id: The alias_id of this CreateMerchantAliaspostPayload.
        :type: str
        """
        if alias_id is None:
    ...
    def merchant_id(self):
        """
        Gets the merchant_id of this CreateMerchantAliaspostPayload.
        A 16 digit-number as per Mobile Push Payment Program Implementation Guide to receive payment by merchant or agent.

        :return: The merchant_id of this CreateMerchantAliaspostPayload.
        :rtype: str
        """
    ...
    def merchant_id(self, merchant_id):
        """
        Sets the merchant_id of this CreateMerchantAliaspostPayload.
        A 16 digit-number as per Mobile Push Payment Program Implementation Guide to receive payment by merchant or agent.

        :param merchant_id: The merchant_id of this CreateMerchantAliaspostPayload.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CreateMerchantAliaspostPayload):
            return False

...
class CreateAliaspostResponse(object):
    """
    ...
    def __init__(self, guid=None):
        """
        CreateAliaspostResponse - a model defined in Swagger
    ...
    def guid(self):
        """
        Gets the guid of this CreateAliaspostResponse.
        GUID of the consumer of issuer is returned if alias is created/updated/deleted successfully.

        :return: The guid of this CreateAliaspostResponse.
        :rtype: str
        """
        return self._guid
    ...
    def guid(self, guid):
        """
        Sets the guid of this CreateAliaspostResponse.
        GUID of the consumer of issuer is returned if alias is created/updated/deleted successfully.

        :param guid: The guid of this CreateAliaspostResponse.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CreateAliaspostResponse):
            return False

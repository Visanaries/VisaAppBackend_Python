...
class UpdateAliaspostResponse(object):
    """
    ...
    def __init__(self, guid=None):
        """
        UpdateAliaspostResponse - a model defined in Swagger
    ...
    def guid(self):
        """
        Gets the guid of this UpdateAliaspostResponse.
        GUID of the consumer of issuer is returned if alias is created/updated/deleted successfully.

        :return: The guid of this UpdateAliaspostResponse.
        :rtype: str
        """
        return self._guid
    ...
    def guid(self, guid):
        """
        Sets the guid of this UpdateAliaspostResponse.
        GUID of the consumer of issuer is returned if alias is created/updated/deleted successfully.

        :param guid: The guid of this UpdateAliaspostResponse.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, UpdateAliaspostResponse):
            return False
